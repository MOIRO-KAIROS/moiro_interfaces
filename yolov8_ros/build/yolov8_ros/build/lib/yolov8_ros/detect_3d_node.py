...
class Detect3DNode(Node):
    ...
    def __init__(self) -> None:
        ...
        # self.info_pub = self.create_publisher(DetectionInfo, 'dectection_info',10) # changed by minha
        # subs
    ...
    def convert_bb_to_3d(
        ...
        # info_msg.average_depth = float(depth_image[center_x][center_y]/1000)
        # info_msg.id = detection.class_id
